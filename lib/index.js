...
(function() {
  ...
  EPub = (function() {
    ...
    EPub.prototype.generateTempFile = function() {
      ...
      return ejs.renderFile(path.resolve(__dirname, "./content.ejs"), this.options, function(err, data) {
        if (err) {
          console.error(err);
          return false;
        }
        ...
        return ejs.renderFile(path.resolve(__dirname, "./toc"), this.options, function(err, data) {
          if (err) {
            console.log(err);
            return false;
          }
          console.log("./content");
          return fs.writeFileSync(path.resolve(self.uuid, "./OEBPS/toc.ncx"), data);
        });
      });
    };
