...
(function() {
  var EPub, Q, cheerio, ejs, exec, fs, path, removeDiacritics, request, uslug, uuid, _;
  ...
  EPub = (function() {
    ...
    EPub.prototype.generateTempFile = function() {
      ...
      Q.all([Q.nfcall(ejs.renderFile, path.resolve(__dirname, "./content.ejs"), self.options), Q.nfcall(ejs.renderFile, path.resolve(__dirname, "./toc.ejs"), self.options), Q.nfcall(ejs.renderFile, path.resolve(__dirname, "./content.html"), self.options)]).spread(function(data1, data2, data3) {
