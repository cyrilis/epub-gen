...
(function() {
  ...
  EPub = class EPub {
    constructor(options, output) {
      ...
      if (this.options.collection !== null && (this.options.collection.name === void 0 || this.options.collection.type === void 0 || this.options.collection.position === void 0)) {
        this.options.collection = null;
      }
      this.id = uuid();
